...
awk_extract_reads = "awk -F'>' 'NR==FNR{ids[$0]; next} NF>1{f=(substr($2,1,36) in ids)} f' nanopore_reads_Paris.txt dys_60000.fa.masked > dys_60000_paris.fa.masked"
remove = "rm nanopore_reads_Paris.txt"
