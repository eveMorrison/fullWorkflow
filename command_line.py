...
for line in fileinput.input("TE_list.txt"):
    ...
    bwa_mem_160 = '''bwa mem strain160all.fasta.masked dys_60000_'''+TE+'''.fa.masked > dys_60000_Normalized160_'''+TE+'''.sam'''
    bwa_mem_9 = '''bwa mem strain9all.fasta.masked dys_60000_'''+TE+'''.fa.masked > dys_60000_Normalized9_'''+TE+'''.sam'''
    ...
    samtools_view_160 = '''samtools view -q 50 -F 0x800 -b dys_60000_Normalized160_'''+TE+'''.sam > dys_60000_Filter160_'''+TE+'''.bam'''
    samtools_view_9 = '''samtools view -q 50 -F 0x800 -b dys_60000_Normalized9_'''+TE+'''.sam > dys_60000_Filter9_'''+TE+'''.bam'''
    ...
    samtools_sort_160 = '''samtools sort dys_60000_Filter160_'''+TE+'''.bam -o dys_60000_Sorted160_'''+TE+'''.bam'''
    samtools_sort_9 = '''samtools sort dys_60000_Filter9_'''+TE+'''.bam -o dys_60000_Sorted9_'''+TE+'''.bam'''
    ...
    bedtools_bamtobed_160 = '''bedtools bamtobed -i dys_60000_Sorted160_'''+TE+'''.bam > dys_60000_160_'''+TE+'''.bed'''
    bedtools_bamtobed_9 = '''bedtools bamtobed -i dys_60000_Sorted9_'''+TE+'''.bam > dys_60000_9_'''+TE+'''.bed'''
    ...
    bedtools_intersect_160 = '''bedtools intersect -a dys_60000_160_'''+TE+'''.bed -b strain160all.'''+TE+'''.extended.bed -v > insert_'''+TE+'''_160.bed'''
    bedtools_intersect_9 = '''bedtools intersect -a dys_60000_9_'''+TE+'''.bed -b strain9all.'''+TE+'''.extended.bed -v > insert_'''+TE+'''_9.bed'''
